...
**(a) Report the test set misclassification error for gbm on thedata set, and also the misclassification error for each class.**
...
initial_split_occu <- initial_split(occup_stats, strata = sex) 
